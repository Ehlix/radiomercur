...
<template>
  <SwitchRoot
    ...
    :class="
      cn(
        'animate-spiner peer relative inline-flex h-8 w-12 shrink-0 cursor-pointer items-center overflow-hidden rounded px-0 text-base font-semibold transition-colors focus-visible:outline-none focus-visible:ring-0 disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-mc-2 data-[state=unchecked]:bg-mc-3',
        props.class,
      )
    "
  >
